    ...
    <div className="animate-fade-in">
      ...
      <div className="max-w-5xl mx-auto px-4 mb-12">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="card-hover border-2 border-green-200 bg-green-50">
            <div className="text-4xl font-display text-green-700 mb-2">3</div>
            <p className="font-bold text-green-800">Marcador Exacto</p>
            <p className="text-xs text-green-600 mt-2 leading-relaxed">
              ¡Clavaste el resultado! Si predijiste 2-1 y el partido terminó 2-1, son tuyos los 3 puntos.
            </p>
          </div>
          <div className="card-hover border-2 border-blue-200 bg-blue-50">
            <div className="text-4xl font-display text-blue-700 mb-2">1</div>
            <p className="font-bold text-blue-800">Acertaste el Ganador</p>
            <p className="text-xs text-blue-600 mt-2 leading-relaxed">
              Sabías quién iba a ganar aunque no el marcador exacto. Si predijiste 1-0 y ganó 3-0, ¡igual sumas!
            </p>
          </div>
          <div className="card-hover border-2 border-purple-200 bg-purple-50">
            <div className="text-4xl font-display text-purple-700 mb-2">+10</div>
            <p className="font-bold text-purple-800">Campeón del Mundo</p>
            <p className="text-xs text-purple-600 mt-2 leading-relaxed">
              ¿Sabes quién levantará la copa? Apuesta antes del primer partido y gana 10 puntos extra que pueden voltear la tabla.
            </p>
          </div>
        </div>
